...
public:
	...
	@return True if the binary tree is empty, or flase if not. */
	...
	@post The desired data has been teturned, and the binary tree
		is unchanged. If not such data was found, an exception is thrown.
	...
	@param visit A client-defined function that performs an operation on
		either each visited node or it's data. */
